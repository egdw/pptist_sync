...
export interface MainState {
  ...
  showPresentationLinkPanel: boolean
...
export const useMainStore = defineStore('main', {
  state: (): MainState => ({
    ...
    showPresentationLinkPanel: false, // 打开放映联动设置面板
  ...
  actions: {
    ...
    setPresentationLinkPanelState(show: boolean) {
      this.showPresentationLinkPanel = show
    },
