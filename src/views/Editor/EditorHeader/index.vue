<template>
  <div class="editor-header">
    <div class="left">
      <Popover trigger="click" placement="bottom-start" v-model:value="mainMenuVisible">
        <template #content>
          ...
          <PopoverMenuItem class="popover-menu-item" @click="openPresentationLinkPanel(); mainMenuVisible = false"><i-icon-park-outline:link class="icon" /> 放映联动</PopoverMenuItem>
    ...
    <Modal
      :visible="showPresentationLinkPanel"
      :width="640"
      closeButton
      :contentStyle="{ maxHeight: '86vh', overflow: 'auto' }"
      @closed="setPresentationLinkPanelState(false)"
    >
...
import PresentationLinkPanel from '../PresentationLinkPanel.vue'
...
const { showPresentationLinkPanel } = storeToRefs(mainStore)
...
const setPresentationLinkPanelState = (show: boolean) => {
  mainStore.setPresentationLinkPanelState(show)
}
